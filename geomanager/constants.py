...
DEFAULT_OPEN_MAP_TILES_STYLE = {
    ...
    "metadata": {
        ...
        "mapbox:groups": {
            "basemap_light": {"name": "basemap-light"},
            "basemap_dark": {"name": "basemap-dark"},
            "basemap_satellite": {"name": "basemap-satellite"},
            "labels_light": {"name": "labels-light"},
            "labels_dark": {"name": "labels-dark"},
            "roads": {"name": "roads"},
        },
    },
    ...
    "layers": [
        {
            ...
            "type": "background",
            "metadata": {"mapbox:group": "basemap_light"},
        },
        {
            "id": "background-dark",
            "type": "background",
            "metadata": {"mapbox:group": "basemap_dark"},
            "layout": {"visibility": "none"},
            "paint": {"background-color": "hsl(60, 2%, 19%)"},
        },
        {
            "id": "background-satellite",
            "type": "background",
            "metadata": {"mapbox:group": "basemap_satellite"},
            "layout": {"visibility": "none"},
        ...
        },
        {
            ...
            "id": "water",
            "paint": {"fill-color": "hsl(203, 95%, 84%)"},
            "layout": {"visibility": "none"},
            "source": "openmaptiles",
            "source-layer": "water",
            "type": "fill",
        ...
        },
        {
            ...
            "paint": {"fill-color": "hsl(203, 95%, 84%)", "fill-opacity": 0.7},
            "layout": {"visibility": "none"},
            "source": "openmaptiles",
            "source-layer": "water",
            "type": "fill",
        ...
        },
        {
            ...
            "paint": {"fill-color": "hsl(60, 5%, 12%)", "fill-opacity": 0.7},
            "layout": {"visibility": "none"},
            "source": "openmaptiles",
            "source-layer": "water",
            "type": "fill",
        ...
        },
        {
            "id": "road_pier",
            "type": "line",
            "metadata": {"mapbox:group": "roads"},
            "source": "openmaptiles",
            "source-layer": "transportation",
            "filter": ["all", ["==", "$type", "LineString"], ["in", "class", "pier"]],
            "layout": {"line-cap": "round", "line-join": "round", "visibility": "none"},
            "paint": {"line-color": "#fffca2", "line-width": {"base": 1.2, "stops": [[15, 1], [17, 4]]}},
        },
        {
            ...
            "layout": {"line-cap": "square", "line-join": "bevel", "visibility": "none"},
            "source": "openmaptiles",
            "source-layer": "transportation",
            "type": "line",
            "metadata": {"mapbox:group": "roads"},
        },
        {
            ...
            "id": "road_minor",
            "paint": {"line-color": "#fffca2", "line-width": {"base": 1.55, "stops": [[4, 0.25], [20, 30]]}},
            "layout": {"line-cap": "round", "line-join": "round", "visibility": "none"},
            "source": "openmaptiles",
            "source-layer": "transportation",
            "type": "line",
        ...
        },
        {
            ...
            "paint": {"line-color": "#fffca2", "line-width": {"base": 1.4, "stops": [[6, 0.5], [20, 30]]}},
            "layout": {"line-cap": "round", "line-join": "round", "visibility": "none"},
            "source": "openmaptiles",
            "source-layer": "transportation",
            "type": "line",
        ...
        },
        {
            ...
            "paint": {"line-color": "#fffca2", "line-width": {"base": 1.4, "stops": [[6, 0.5], [20, 20]]}},
            "layout": {"line-cap": "round", "line-join": "round", "visibility": "none"},
            "source": "openmaptiles",
            "source-layer": "transportation",
            "type": "line",
        ...
        },
        {
            ...
            "source-layer": "poi",
            "type": "symbol",
            "metadata": {"mapbox:group": "labels_light"},
        },
        {
            "filter": ["all", ["==", "$type", "Point"], ["==", "rank", 1]],
            "id": "poi_label_dark",
            ...
            "source-layer": "poi",
            "type": "symbol",
            "metadata": {"mapbox:group": "labels_dark"},
        },
        {
            "filter": ["all", ["has", "iata"]],
            "id": "airport-label",
        ...
        },
        {
            ...
            "paint": {
                "text-halo-width": 1.25,
                "text-halo-color": {"base": 1, "stops": [[2, "rgba(255,255,255,0.75)"], [3, "#fff"]]},
                "text-color": "hsl(0, 0%, 0%)",
                "text-opacity": 0.7,
            },
            "source": "openmaptiles",
