...
from geomanager.views import (
    ...
    AdditionalBoundaryCreateView,
    AdditionalBoundaryEditView,
    AdditionalBoundaryDeleteView,
)
...
urls = [
    ...
    path("additional-boundary/edit/<int:pk>", AdditionalBoundaryEditView.as_view(), name="additional_boundary_edit"),
    path(
        "additional-boundary/delete/<int:pk>", AdditionalBoundaryDeleteView.as_view(), name="additional_boundary_delete"
    ),
]
