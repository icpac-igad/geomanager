...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={
                "ordering": ["time"],
                "verbose_name": "Layer Raster File",
                "verbose_name_plural": "Layer Raster Files",
            },
        ),
        migrations.AlterModelOptions(
            name="mbtsource",
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="geomanager.subcategory", verbose_name="Subcategory"
            ),
        ),
        migrations.AlterField(
                    ...
                    (
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ...
                                ("filter", wagtail.blocks.CharBlock(required=False)),
                                ("maxzoom", wagtail.blocks.IntegerBlock(required=False)),
                                ("minzoom", wagtail.blocks.IntegerBlock(required=False)),
                            ],
                            label="Polygon Layer",
                        ),
                    ),
                                ...
                                (
                                    ...
                                    wagtail.blocks.StructBlock(
                                        [
                                            ...
                                            ("line_dasharray", wagtail.blocks.CharBlock(required=False)),
                                            (
                                                "line_gap_width",
                                                wagtail.blocks.FloatBlock(
                                                    default=0.0,
                                ...
                                (
                                    ...
                                    wagtail.blocks.StructBlock(
                                        [
                                            ...
                                            ("icon_offset", wagtail.blocks.CharBlock(required=False)),
                                            (
                                                "icon_optional",
                                                wagtail.blocks.BooleanBlock(default=False, required=False),
                                            ),
                                ...
                                (
                                    ...
                                    wagtail.blocks.StructBlock(
                                        [
                                            ...
                                            ("text_translate", wagtail.blocks.CharBlock(required=False)),
                                            (
                                                "text_translate_anchor",
                                                wagtail.blocks.ChoiceBlock(
                                                    choices=[("map", "Map"), ("viewport", "Viewport")], required=False
                                                ),
                                            ),
                                        ],
                                        label="Mapbox GL Paint Properties",
                                ...
                                (
                                    ...
                                    wagtail.blocks.StructBlock(
                                        [
                                            ...
                                            ("text_field", wagtail.blocks.CharBlock(required=True)),
                                            (
                                                "text_size",
                                                wagtail.blocks.IntegerBlock(
                                                    default=16,
                                            ...
                                            ("text_offset", wagtail.blocks.CharBlock(required=False)),
                                            (
                                                "text_opacity",
                                                wagtail.blocks.FloatBlock(
                                                    default=1.0,
