    ...
    operations = [
                    ...
                    wagtail.fields.StreamField(
                        [
                            (
                                ...
                                wagtail.blocks.StructBlock(
                                    [
                                        ("link_text", wagtail.blocks.CharBlock(label="Link text", required=True)),
                                        ("link_url", wagtail.blocks.URLBlock(label="Link Url", required=True)),
                                        (
                                            "text",
                                            wagtail.blocks.TextBlock(label="Short description text", required=False),
                                        ),
                                        (
                                            "is_button",
                                            wagtail.blocks.BooleanBlock(
                                                default=True, label="Format link as action button", required=False
                                            ),
                                        ),
                                        (
                                            "show_arrow",
                                            wagtail.blocks.BooleanBlock(
                                                default=True, label="Show arrow in button", required=False
                                            ),
                                        ),
                                    ],
                                    label="Info link",
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="geomanager.subcategory", verbose_name="Sub category"
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=modelcluster.fields.ParentalKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="icons", to="geomanager.vectorfilelayer"
            ),
        ),
        migrations.DeleteModel(
            name="FileImageLayer",
