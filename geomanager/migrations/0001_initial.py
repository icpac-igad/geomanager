    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "active",
                    models.BooleanField(default=True, help_text="Is the category active ?", verbose_name="active"),
                ),
                (
                    "public",
                    models.BooleanField(default=True, help_text="Is the category public ?", verbose_name="public"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="The Dataset title as will appear to the public", max_length=255, verbose_name="title"
                    ),
                ),
                (
                    "summary",
                ...
                (
                    "layer_type",
                    models.CharField(
                        choices=[("file", "Raster"), ("wms", "WMS"), ("vector", "Vector")],
                        default="file",
                        max_length=100,
                ...
                (
                    "multi_temporal",
                    models.BooleanField(
                        default=True, help_text="The dataset is multi-temporal", verbose_name="multi-temporal"
                    ),
                ),
                (
                    "multi_layer",
                ...
                (
                    "category",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="geomanager.category", verbose_name="category"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subtitle",
                    models.CharField(
                        blank=True, help_text="Subtitle if any", max_length=255, null=True, verbose_name="subtitle"
                    ),
                ),
                (
                    "function",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Style name for identification", max_length=256, verbose_name="name"),
                ),
                (
                    "unit",
                    models.CharField(
                        blank=True, help_text="Data unit", max_length=100, null=True, verbose_name="data unit"
                    ),
                ),
                ...
                (
                    "interpolate",
                    models.BooleanField(default=False, help_text="Interpolate colorscale", verbose_name="interpolate"),
                ),
                (
                    ...
                    wagtail_color_panel.fields.ColorField(
                        blank=True,
                        default="#ff0000",
                        help_text="Color for values greater than the values defined above, as well as values greater than the maximum value",
                        max_length=7,
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "format",
                    models.CharField(
                        choices=[("image/png", "PNG"), ("image/jpeg", "JPEG"), ("image/gif", "GIF")],
                        default="image/png",
                        ...
                        [
                            (
                                ...
                                wagtail.blocks.StructBlock(
                                    [
                                        ("name", wagtail.blocks.CharBlock(label="name")),
                                        ("label", wagtail.blocks.CharBlock(label="label", required=False)),
                                        (
                                            "type",
                                            wagtail.blocks.ChoiceBlock(
                                                choices=[("radio", "Radio"), ("dropdown", "Dropdown")],
                                                label="Selector Type",
                                            ),
                                        ),
                                        (
                                            ...
                                            wagtail.blocks.ListBlock(
                                                wagtail.blocks.StructBlock(
                                                    [
                                                        ...
                                                        ("value", wagtail.blocks.CharBlock(label="value")),
                                                        (
                                                            "default",
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="Arrange Param Selectors side by side"),
                ),
                (
                    "legend",
                    wagtail.fields.StreamField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dataset",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="geomanager.dataset"
                    ),
                ),
            ],
            options={
                            ...
                            (
                                ...
                                wagtail.blocks.StructBlock(
                                    [
                                                ...
                                                [
                                                    (
                                                        ...
                                                        wagtail_color_panel.blocks.NativeColorBlock(
                                                            default="#000000", label="fill color", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "fill_opacity",
                                                    ...
                                                    (
                                                        "fill_antialias",
                                                        wagtail.blocks.BooleanBlock(
                                                            default=True, label="fill antialias", required=False
                                                        ),
                                                    ),
                                                ],
                                        ...
                                        ("filter", wagtail.blocks.CharBlock(label="filter", required=False)),
                                        ("maxzoom", wagtail.blocks.IntegerBlock(label="maxzoom", required=False)),
                                        ("minzoom", wagtail.blocks.IntegerBlock(label="minzoom", required=False)),
                                    ],
                                    label="Polygon Layer",
                                ),
                            ),
                                            ...
                                            wagtail.blocks.StructBlock(
                                                [
                                                    (
                                                        "line_color",
                                                        wagtail_color_panel.blocks.NativeColorBlock(
                                                            default="#000000", label="Line color", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "line_dasharray",
                                                        wagtail.blocks.CharBlock(
                                                            label="Line dasharray", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "line_gap_width",
                                            ...
                                            wagtail.blocks.StructBlock(
                                                [
                                                    (
                                                        "circle_color",
                                                        wagtail_color_panel.blocks.NativeColorBlock(
                                                            default="#000000", label="circle color", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "circle_opacity",
                                            ...
                                            wagtail.blocks.StructBlock(
                                                [
                                                    ...
                                                    (
                                                        "icon_allow_overlap",
                                                        wagtail.blocks.BooleanBlock(
                                                            default=False, label="Icon allow overlap", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "icon_anchor",
                                                    ...
                                                    (
                                                        ...
                                                        wagtail.blocks.BooleanBlock(
                                                            default=False, label="Icon ignore placement", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "icon_keep_upright",
                                                        wagtail.blocks.BooleanBlock(
                                                            default=False, label="Icon keep upright", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "icon_offset",
                                                        wagtail.blocks.CharBlock(label="Icon offset", required=False),
                                                    ),
                                                    (
                                                        "icon_optional",
                                                        wagtail.blocks.BooleanBlock(
                                                            default=False, label="Icon optional", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "icon_padding",
                                            ...
                                            wagtail.blocks.StructBlock(
                                                [
                                                    ...
                                                    (
                                                        "icon_halo_color",
                                                        wagtail_color_panel.blocks.NativeColorBlock(
                                                            default="#000000", label="Icon halo color", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "icon_halo_width",
                                            ...
                                            wagtail.blocks.StructBlock(
                                                [
                                                    (
                                                        "text_color",
                                                        wagtail_color_panel.blocks.NativeColorBlock(
                                                            default="#000000", label="Text color", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "text_halo_blur",
                                                    ...
                                                    (
                                                        "text_halo_color",
                                                        wagtail_color_panel.blocks.NativeColorBlock(
                                                            default="#000000", label="Text halo color", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "text_halo_width",
                                                    ...
                                                    (
                                                        "text_translate",
                                                        wagtail.blocks.CharBlock(
                                                            label="Text translate", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "text_translate_anchor",
                                                        wagtail.blocks.ChoiceBlock(
                                                            choices=[("map", "Map"), ("viewport", "Viewport")],
                                            ...
                                            wagtail.blocks.StructBlock(
                                                [
                                                    ...
                                                    (
                                                        "text_allow_overlap",
                                                        wagtail.blocks.BooleanBlock(
                                                            default=False, label="Text allow overlap", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "text_anchor",
                                                    ...
                                                    ("text_field", wagtail.blocks.CharBlock(label="Text field")),
                                                    (
                                                        "text_size",
                                                        wagtail.blocks.IntegerBlock(
                                                            default=16,
                                                    ...
                                                    (
                                                        ...
                                                        wagtail.blocks.BooleanBlock(
                                                            default=False, label="Text ignore placement", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "text_justify",
                                                    ...
                                                    (
                                                        "text_keep_upright",
                                                        wagtail.blocks.BooleanBlock(
                                                            default=False, label="Text keep upright", required=False
                                                        ),
                                                    ),
                                                    (
                                                        "text_letter_spacing",
                                                    ...
                                                    (
                                                        "text_offset",
                                                        wagtail.blocks.CharBlock(label="Text offset", required=False),
                                                    ),
                                                    (
                                                        "text_opacity",
                                                        wagtail.blocks.FloatBlock(
                ...
                (
                    ...
                    wagtail.fields.StreamField(
                        [
                            ...
                            ("legend_image", wagtail.images.blocks.ImageChooserBlock(label="Legend Image")),
                            (
                                "legend_icon",
                                wagtail.blocks.StructBlock(
                                    [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "how_do_you_use",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="How do you Use"),
                ),
                        ...
                        [
                            (
                                ...
                                wagtail.blocks.StructBlock(
                                    [
                                        ("label", wagtail.blocks.CharBlock(label="label")),
                                        ("backgroundColor", wagtail.blocks.CharBlock(label="background color")),
                                        (
                                            "image",
                                            wagtail.images.blocks.ImageChooserBlock(label="image", required=False),
                                        ),
                                        ("basemapGroup", wagtail.blocks.CharBlock(label="basemap group")),
                                        ("labelsGroup", wagtail.blocks.CharBlock(label="labels group")),
                                        ("url", wagtail.blocks.URLBlock(label="url", required=False)),
                                        (
                                            "default",
                                            wagtail.blocks.BooleanBlock(
                                                help_text="Is default style ?", label="default", required=False
                                            ),
                                        ),
                                    ]
                                ),
                                ...
                                wagtail.blocks.StructBlock(
                                    [
                                        (
                                            ...
                                            wagtail.blocks.BooleanBlock(
                                                default=True, label="Show data for point", required=False
                                            ),
                                        ),
                                        (
                                            "timeseries_data_enabled",
                                            wagtail.blocks.BooleanBlock(
                                                default=True, label="Show timeseries data for point", required=False
                                            ),
                                        ),
                                        ("unit", wagtail.blocks.CharBlock(label="Data unit", required=False)),
                                        (
                                            "timeseries_chart_type",
                                            wagtail.blocks.ChoiceBlock(
                                                choices=[("lines", "Line Chart"), ("bars", "Bar Chart")],
                                                label="Chart Type",
                                            ),
                                        ),
                                        (
                                            ...
                                            wagtail_color_panel.blocks.NativeColorBlock(
                                                default="#367DA4", label="Chart Line/Bar Color", required=True
                                            ),
                                        ),
                                    ],
                                ...
                                wagtail.blocks.StructBlock(
                                    [
                                        (
                                            "instance_data_enabled",
                                            wagtail.blocks.BooleanBlock(
                                                default=True, label="Show data for area", required=False
                                            ),
                                        ),
                                        (
                                            "instance_value_type",
                                        ...
                                        (
                                            "timeseries_data_enabled",
                                            wagtail.blocks.BooleanBlock(
                                                default=True, label="Show timeseries data for area", required=False
                                            ),
                                        ),
                                        (
                                            "timeseries_aggregation_method",
                                            wagtail.blocks.ChoiceBlock(
                                                choices=[("mean", "By Mean"), ("sum", "By Sum")],
                                        ...
                                        (
                                            "timeseries_chart_color",
                                            wagtail_color_panel.blocks.NativeColorBlock(
                                                default="#367DA4", label="circle stroke color", required=True
                                            ),
                                        ),
                                    ],
                                    label="Area Analysis",
        ...
        migrations.AddField(
            ...
            name="sub_category",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="geomanager.subcategory", verbose_name="sub_category"
            ),
        ),
        migrations.CreateModel(
            name="ColorValue",
