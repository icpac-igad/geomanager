    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="MapViewer Map disclaimer page for more details",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="+",
                to="wagtailcore.page",
                verbose_name="Map Disclaimer Page",
            ),
        ),
        migrations.AddField(
            model_name="geomanagersettings",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ("basic", "Basic"),
                    ("choropleth", "Choropleth Horizontal"),
                    ("choropleth_vertical", "Choropleth Vertical"),
                    ("gradient", "Gradient Horizontal"),
                    ("gradient_vertical", "Gradient Vertical"),
                ],
                default="choropleth_vertical",
                max_length=100,
                verbose_name="Legend Type",
            ),
        ),
        migrations.AlterField(
