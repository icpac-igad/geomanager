...
class GeomanagerSettings(BaseSiteSetting, ClusterableModel):
    ...
    logo_external_link = models.URLField(
        max_length=255,
        null=True,
        blank=True,
    ...
    map_disclaimer_text = models.CharField(
        max_length=350,
        blank=True,
        null=True,
        ...
        help_text=_(
            "MapViewer Map disclaimer text. Maximum of 350 characters. "
            ...
            (
                ...
                blocks.StructBlock(
                    [
                        ...
                        (
                            "backgroundColor",
                            blocks.CharBlock(label=_("background color")),
                        ),
